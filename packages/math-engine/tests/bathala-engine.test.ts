...
function fixture(overrides: Partial<ActiveGameConfig> = {}): ActiveGameConfig {
  ...
  return {
    ...
    metadata: { profileName: 'Test', version: '1.0.0', volatilityProfile: 'custom' },
    betting: { bets: [1, 2], defaultBet: 1, startingCredits: 1000, autoSpinOptions: [1, 10] },
    references: { targetRtp: 0.96, featureEntrySpins: 100 },
    limits: { maximumWinMultiple: 10000, maximumMultiplier: 500, maximumSessionRecords: 100000 },
